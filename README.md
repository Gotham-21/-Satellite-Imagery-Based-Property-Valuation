...
Note: You need a Google Maps Static API key to download satellite images. Get one from Google Cloud Console.
...
Run data_fetcher.py locally first to generate:
...
Run preprocessings.ipynb first (for EDA)
Run model-training.ipynb (for training + submission)
